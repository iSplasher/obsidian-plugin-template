import PluginNotice from "@/components/notice";
import { constant } from "@/constants";

import { PluginConsoleError, PluginError } from "./error";
...
export default class logger {
	...
	static exception(e: Error | PluginConsoleError, notice = true): void {
